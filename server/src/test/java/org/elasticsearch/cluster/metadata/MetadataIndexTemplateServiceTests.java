...
public class MetadataIndexTemplateServiceTests extends ESSingleNodeTestCase {
    ...
    public void testRemoveComponentTemplate() throws Exception {
        ...
        ComponentTemplate expectedTemplateBar = new ComponentTemplate(bar.template(), bar.version(), bar.metadata(), bar.deprecated(), 1L, 1L);
        ComponentTemplate expectedTemplateBaz = new ComponentTemplate(baz.template(), baz.version(), baz.metadata(), baz.deprecated(), 2L, 2L);
        ...
        ComponentTemplate expectedTemplateFoo = new ComponentTemplate(foo.template(), foo.version(), foo.metadata(), foo.deprecated(), 0L, 0L);
